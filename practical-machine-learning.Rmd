...
set.seed(1234)
setwd("N:/R-work/practical-machine-learning")
```
...
Irrelevant variables will be deleted. Results will be hidden from the report for clarity and space considerations.
